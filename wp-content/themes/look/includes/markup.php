 ...
 * @package    look
 * @author     MagicalTheme
 * @copyright  Copyright (C) 2014 magicaltheme.com. All Rights Reserved.
 ...
 * @since    1.0
 */
if ( ! function_exists( 'look_schema_metadata' ) ) :
	/**
	 ...
	 * @return  void
	 */
function look_schema_metadata( $args ) {
	if ( ! empty( $args ) ) {
		$args = array_merge(
			array(
				'post_type' => '',
	...
	$args = apply_filters( 'look_schema_metadata_args', $args );
	...
	$attributes = apply_filters( 'look_schema_metadata_attributes', $attributes, $args );
	...
	$markup = apply_filters( 'look_schema_metadata_output', $markup, $args );
